...
const translations = {
  en: {
    ...
    toolsSettings: "Tools", toolsSettingsTitle: "Tool and file limits", toolsSettingsDesc: "Control tool iterations, downloads, PDF processing, and temporary upload cleanup.", maxToolRounds: "Maximum tool rounds", maxAttachments: "Attachments per message", textDownloadLimit: "Text download limit (MB)", textCharacterLimit: "Text characters sent to model", imageDownloadLimit: "Image URL limit (MB)", imageUploadLimit: "Image upload limit (MB)", pdfSizeLimit: "PDF limit (MB)", pdfPageLimit: "PDF pages processed", pdfTextLimit: "PDF characters sent to model", pdfVisionPages: "Scanned PDF vision pages", pdfTimeout: "PDF processing timeout (seconds)", temporaryFileTtl: "Temporary file cleanup (minutes)", orphanTtl: "Unattached upload retention (hours)", toolsSafetyHelp: "Values are validated against server safety boundaries when saved.",
