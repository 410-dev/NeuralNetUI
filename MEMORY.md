...
- Version 2.1.0 MSI built and metadata verified on 2026-09-09; unsigned. Output: `installer/output/NeuralNetUI-2.1.0-x64.msi`. Validation notes: `docs/audits/2026-09-09-release-2.1.0.md`; the 2.0.0 notes are in `docs/audits/2026-09-09-design-2.0.0.md`.
