...
- Version 2.0.0 MSI built and metadata verified on 2026-09-09; unsigned. Output: `installer/output/NeuralNetUI-2.0.0-x64.msi`. 2.0.0 changes presentation and adds appearance preferences only; no harness behaviour, stored conversation or migration changed. Validation notes: `docs/audits/2026-09-09-design-2.0.0.md`.
